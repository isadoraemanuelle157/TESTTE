...
<select v-model="form.generoId" required>
        ...
        <section class="list-section">
          <div class="section-header list-header">
            ...
            <div class="list-filters">
              <button 
                v-for="filter in ['Todas', 'Feliz', 'Triste', 'Animado']" 
                :key="filter"
            ...
            >
              ...
              <div class="card-content">
                ...
                <div class="music-meta">
                  ...
                  <span class="mood">🎶 {{ musica.generoId?.nome }}</span>
                </div>
 ...
 mounted() {
  ...
  methods: {
    ...
    async salvarMusica() {
      this.loading = true
      try {
        // Prepara os dados - se não tiver foto válida, envia vazio ou default
        const payload = {
          ...this.form,
          foto: this.form.foto && this.isValidUrl(this.form.foto) ? this.form.foto : this.defaultImage
        }
