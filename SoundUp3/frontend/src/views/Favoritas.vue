    ...
    <transition name="fade">
      <div v-if="!loading && favoritasFiltradas.length === 0" class="empty-state">
        <div class="empty-illustration">
         ...
         <h3>{{ favoritas.length === 0 ? 'Nenhuma favorita do Spotify ainda' : 'Nenhum resultado encontrado' }}</h3>
  <p>{{ favoritas.length === 0 ? 'Comece a explorar o Spotify e adicione músicas, álbuns e artistas aos seus favoritos!' : 'Tente mudar o filtro.' }}</p>
