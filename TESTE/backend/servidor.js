  ...
  try {
    ...
    const moods = [
      {
        ...
        name: 'Festa',
        emoji: '🎉',
        description: 'Batidas animadas para curtir a noite',
        tags: ['dança', 'energia', 'balada'],
      ...
      },
      {
        ...
        name: 'Treino',
        emoji: '💪',
        description: 'Músicas para manter o ritmo e a motivação',
        tags: ['energia', 'foco', 'academia'],
      ...
      },
      {
        ...
        name: 'Chill',
        emoji: '🌈',
        description: 'Clima leve para relaxar e curtir',
        tags: ['leve', 'calmo', 'vibes'],
      ...
      },
      {
        ...
        name: 'Focus',
        emoji: '🧠',
        description: 'Som ideal para concentração',
        tags: ['estudo', 'trabalho', 'foco'],
      ...
      },
      {
        ...
        name: 'Relax',
        emoji: '🌙',
        description: 'Para desacelerar e descansar',
        tags: ['sono', 'paz', 'calma'],
    ...
    console.error('❌ Erro ao buscar vibes Spotify:', error.response?.data || error.message)
    res.status(500).json({
      error: 'Erro ao buscar vibes na API',
      details: error.response?.data?.error?.message || error.message
    })
  }
})
